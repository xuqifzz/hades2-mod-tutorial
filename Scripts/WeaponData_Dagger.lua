OverwriteTableKeys( WeaponData, 
{
	...
	WeaponDagger =
	{
		...
		SwapAnimations =
		{
			...
			["Melinoe_GetHit_LastStand"] = "Melinoe_Dagger_GetHit_LastStand",
	...
	WeaponDagger5 =
	{
		...
		OnChargeFunctionNames = { "MarkDaggerTarget", },
	...
	WeaponDaggerThrow = 
	{
		...
		MaxChargeText = { Text = "SpearSpinMaxMessage", Duration = 0.4, OffsetY = -160, SkipShadow = true, SkipRise = true },
		...
		ChargeWeaponStages =
		{
				{ ManaCost = 6, WeaponProperties = { Projectile = "ProjectileDaggerThrowCharged", FireGraphic = "Melinoe_Dagger_SpecialEx_Fire", NumProjectiles = 2, AdditionalProjectileWaveChance = 0, ProjectileInterval = 0.08}, ApplyEffects = { "WeaponDaggerThrowEXDisable", "WeaponDaggerThrowEXDisableCancellable", "WeaponDaggerThrowEXDisableMoveHold" }, Wait = 0.32, HideStageReachedFx = true, ChannelSlowEventOnEnter = true },
