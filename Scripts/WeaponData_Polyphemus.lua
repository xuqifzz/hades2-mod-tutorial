WeaponSetData =
{
	...
	PolyphemusStomp =
	{
		...
		AIData =
		{
			...
			AttackSlots =
			{
				{ UseAngleBetween = true, OffsetDistance = 350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30, PauseDuration = 0.3 },

				{ UseAngleBetween = true, OffsetDistance = 600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -60 },
				{ UseAngleBetween = true, OffsetDistance = 600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30 },
				{ UseAngleBetween = true, OffsetDistance = 600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 60, PauseDuration = 0.3 },


				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -90 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -60 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 60 },
				{ UseAngleBetween = true, OffsetDistance = 850, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 90, PauseDuration = 0.3 },


				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -90 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -60 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -45 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -15 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 15 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 45 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 60 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 75 },
				{ UseAngleBetween = true, OffsetDistance = 1100, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 90, PauseDuration = 0.3 },


				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -90 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -60 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -45 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -15 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 15 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 45 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 60 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 75 },
				{ UseAngleBetween = true, OffsetDistance = 1350, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 90, PauseDuration = 0.3 },


				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -90 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -60 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -45 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -30 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = -15 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 30 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 15 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 45 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 60 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 75 },
				{ UseAngleBetween = true, OffsetDistance = 1600, OffsetScaleY = 0.48, OffsetFromAttacker = true, UseAttackerAngle = true, OffsetY = -75, OffsetAngle = 90, PauseDuration = 0.3 },
			},
	...
	PolyphemusLeap =
	{
		...
		AIData =
		{
			...
			PreAttackVoiceLines =
			{
				...
				{ Cue = "/VO/Polyphemus_0231", Text = "And, heave...!" },
			},
		},
	...
	PolyphemusMegaLeap =
	{
		...
		AIData =
		{
			...
			ProjectileName = "PolyphemusLeapTouchdown",
	...
	PolyphemusSearch =
	{
		...
		AIData =
		{
			...
			SpawnOnIds = { 658445, 658446, 658295 }, -- 
			SpawnsPerBurst = 1,
			MaxActiveSpawns = 5,
